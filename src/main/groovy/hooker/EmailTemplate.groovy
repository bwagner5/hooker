...
class EmailTemplate {
    ...
    public static String generateEmailHtml(String greeting, String preheader, String message, String linkUrl, String linkText){
        return """
        <!DOCTYPE html>
        <html>
          <head>
                      ...
                      <table border="0" cellpadding="0" cellspacing="0" style="border-collapse:separate;mso-table-lspace:0pt;mso-table-rspace:0pt;width:100%;">
                        <tr>
                          <td class="content-block" style="font-family:sans-serif;font-size:14px;vertical-align:top;color:#999999;font-size:12px;text-align:center;">
                            <span class="apple-link" style="color:#999999;font-size:12px;text-align:center;">Triple Tech Inc, 13755 Sunrise Valley Drive Suite 450, Herndon VA 20171</span>
                          </td>
                        </tr>
                      </table>
                    </div>
